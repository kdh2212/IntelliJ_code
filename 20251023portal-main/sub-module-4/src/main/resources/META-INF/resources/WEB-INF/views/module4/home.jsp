...
<body>
        ...
        <div class="content">
            ...
            <div class="feature">
                ...
                <div class="feature-content">
                    <h3>기능 1</h3>
                    <p>모듈 4의 첫 번째 기능입니다. 이 기능은 데이터 관리 및 분석을 위한 고급 도구를 제공합니다. 자세한 내용을 확인하려면 아래 버튼을 클릭하세요.</p>
            ...
            <div class="feature">
                ...
                <div class="feature-content">
                    <h3>기능 3</h3>
                    <p>모듈 4의 세 번째 기능입니다. 클라우드 기반 데이터 저장 및 동기화 기능을 제공하여 언제 어디서나 데이터에 접근할 수 있습니다. 현재 개발 중인 기능입니다.</p>
                    <a href="#" style="background-color: #999;">준비 중</a>
                </div>
            </div>
        </div>
    ...
    <footer>
        <p>&copy; 2025 ${portalName}. All rights reserved.</p>
    </footer>
</body>
</html> 